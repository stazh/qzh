            ...
            return
                    ...
                    case element(org) return
                        if ($parameters?header='context') then
                            ...
                            (
                                ...
                                html:link($config, ., ("tei-org3", css:map-rend-to-class(.)), orgName/string(), (), '_new', map {"link": '../organization/all/' || orgName/string() || '?key=' || @xml:id}),
                        ...
                        if ($parameters?header='context') then
                            let $params := 
                                map {
                                    ...
                                    (:":  let $register := doc("/db/apps/qzh-data/organization/organization.xml")  let $entries:=      for $p in root(.)//text//orgName[@ref]             group by $k := $p/@ref    return          id($p[1]/@ref, $register)      return   for $p in $entries          order by $p/orgName ascending             return                 $p                    ,:)
                    ...
                    case element(place) return
                        if ($parameters?header='context') then
                            ...
                            (
                                ...
                                html:link($config, ., ("tei-place3", css:map-rend-to-class(.)), placeName[1]/string(), (), '_new', map {"link": '../places/all/' || placeName[1]/string() || '?key=' || @xml:id}),
                    ...
                    case element(orgName) return
                        if (@ref and id(replace(@ref, ' ', '-'), doc("/db/apps/qzh-data/organization/organization.xml"))) then
                            let $params := 
                                map {
                                    "alternate": id(replace(@ref, ' ', '-'), doc("/db/apps/qzh-data/organization/organization.xml")),
                                    "default": .,
                                    "ref": @ref,
                                    "content": .
                                }
                            ...
                            if (@ref) then
                                html:link($config, ., ("tei-orgName2", "semantic", "organization", css:map-rend-to-class(.)), ., 'https://www.ssrq-sds-fds.ch/persons-db-edit/?query=' || replace(@ref, ' ', '-'), (), map {})
                            else
                                $config?apply($config, ./node())
                    ...
                    case element(person) return
                        if ($parameters?header='context') then
                            ...
                            (
                                ...
                                html:link($config, ., ("tei-person3", css:map-rend-to-class(.)), persName[@type='full']/string(), (), '_new', map {"link": '../people/all/' || persName[@type='full']/string() || '?key=' || @xml:id})
                            )
                        ...
                        if (parent::respStmt and ../preceding-sibling::respStmt) then
                            ...
                            if (parent::respStmt) then
                                ...
                                if (@ref and id(replace(@ref, ' ', '-'), doc("/db/apps/qzh-data/person/person.xml"))) then
                                    ...
                                    if (@ref) then
                                        html:link($config, ., ("tei-persName4", "semantic", "person", css:map-rend-to-class(.)), ., 'https://www.ssrq-sds-fds.ch/persons-db-edit/?query=' || replace(@ref, ' ', '-'), (), map {})
                                    else
                                        $config?apply($config, ./node())
                    ...
                    case element(placeName) return
                        if (@ref and id(replace(@ref, ' ', '-'), doc("/db/apps/qzh-data/place/place.xml"))) then
                            let $params := 
                                map {
                                    "alternate": id(replace(@ref, ' ', '-'), doc("/db/apps/qzh-data/place/place.xml")),
                                    "default": .,
                                    "ref": @ref,
                                    "content": .
                                }
                            ...
                            if (@ref) then
                                html:link($config, ., ("tei-placeName2", "semantic", "place", css:map-rend-to-class(.)), ., 'https://www.ssrq-sds-fds.ch/places-db-edit/views/view-place.xq?id=' || replace(@ref, ' ', '-'), (), map {})
                            else
                                $config?apply($config, ./node())
