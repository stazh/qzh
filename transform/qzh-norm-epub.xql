                    ...
                    case element(place) return
                        if ($parameters?header='context') then
                            ...
                            (
                                ...
                                html:link($config, ., ("tei-place3", css:map-rend-to-class(.)), placeName[@type="main"]/string(), (), '_new', map {"link": '../places/all/' || placeName[@type="main"]/string() || '?key=' || @xml:id}),
                    ...
                    case element(person) return
                        if ($parameters?header='context') then
                            ...
                            (
                                ...
                                html:link($config, ., ("tei-person3", css:map-rend-to-class(.)), persName[@type='full_sorted']/string(), (), '_new', map {"link": '../people/all/' || persName[@type='full_sorted']/string() || '?key=' || @xml:id})
                            )
