...
module namespace model="http://www.tei-c.org/pm/models/rqzh/epub";
                    ...
                    case element(choice) return
                        if (sic and corr) then
                            ...
                            if (abbr and expan) then
                                epub:alternate($config, ., ("tei-choice2", "text-critical", css:map-rend-to-class(.)), ., abbr[1], expan[1])
                            else
                                if (orig and reg) then
                                    epub:alternate($config, ., ("tei-choice3", "text-critical", css:map-rend-to-class(.)), ., orig[1], reg[1])
                                else
                                    $config?apply($config, ./node())
                                    ...
                                    if (. is ancestor::p/node()[1]) then
                                        ...
                                        if (@break='no') then
                                            (
                                                ...
                                                epub:break($config, ., ("tei-lb6", css:map-rend-to-class(.)), ., 'page', @n)
                                            )

                                        else
                                            epub:break($config, ., ("tei-lb7", css:map-rend-to-class(.)), ., 'line', @n)
                                        ...
                                        if (parent::figure) then
                                            ...
                                            if (parent::table) then
                                                ...
                                                if (parent::lg) then
                                                    ...
                                                    if (parent::list) then
                                                        epub:block($config, ., ("tei-head9", css:map-rend-to-class(.)), .)
                                                    else
